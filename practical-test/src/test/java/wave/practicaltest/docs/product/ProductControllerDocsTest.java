package wave.practicaltest.docs.product;
...
import wave.practicaltest.docs.RestDocsSupport;
...
public class ProductControllerDocsTest extends RestDocsSupport {
    ...
    void createProduct() throws Exception {
        ...
        given(productService.createProduct(any(ProductCreateServiceRequest.class))).willReturn(ProductResponse.builder()
                        .id(1L)
                        .productNumber("001")
                        .sellingStatus(ProductSellingStatus.SELLING)
                        .type(ProductType.HANDMADE)
                ...
                .andDo(document("product-create",
                        ...
                        , responseFields(
                                ...
                                fieldWithPath("data.type").type(JsonFieldType.STRING)
                                        .description("상품 타입"),
                                fieldWithPath("data.sellingStatus")
                                        .description("상품 판매상태"),
